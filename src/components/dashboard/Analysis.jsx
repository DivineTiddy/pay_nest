      ...
      <div className="border-[1px] border-[#E3E3E3] rounded-2xl mt-5 w-full p-4 lg:p-2 ">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-5">
          <span className="flex items-center gap-2">
            ...
            <p className="text-[#767676] font-inter font-normal text-xs lg:text-base">Transfer</p>
          </span>
          <span className="flex items-center gap-2">
            <Circle width={12} height={12} fill="#CA6720" color="#CA6720" />
            <p className="text-[#767676] font-inter font-normal text-xs lg:text-base">Data Bundle</p>
          </span>
          <span className="flex items-center gap-2">
            <Circle width={12} height={12} fill="#333C04" color="#333C04" />
            <p className="text-[#767676] font-inter font-normal text-xs lg:text-base">Airtime</p>
          </span>
          <span className="flex items-center gap-2">
            <Circle width={12} height={12} fill="#D22363" color="#D22363" />
            <p className="text-[#767676] font-inter font-normal text-xs lg:text-base">Electricity</p>
          </span>
          <span className="flex items-center gap-2">
            <Circle width={12} height={12} fill="#D5C944" color="#D5C944" />
            <p className="text-[#767676] font-inter font-normal text-xs lg:text-base">TV Subscription</p>
          </span>
        </div>
      </div>
    </div>
