...
const Register = () => {
  ...
  return (
    <div className="bg-[#F5F5F5] px-7 lg:px-0 h-screen w-full flex justify-center items-center">
        {/* Registration Form */}
        <div
          className={`${
        ...
        >
          ...
          <div className="flex flex-col justify-center mt-7">
            ...
            >
              <div className="text-[#2B2B2B] w-full  md:flex items-center justify-between">
        ...
        >
          ...
          <p className="text-[#767676] font-normal text-base mt-3">
